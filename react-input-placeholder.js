...
(function(){
  ...
  if (typeof module !== 'undefined' && module.exports) {
    ...
    var components = initComponents(React);
    window.InputPlaceholder = components.input;
    window.TextAreaPlaceholder = components.textarea;
  }
})();
